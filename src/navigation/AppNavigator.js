...
const ProjectStackNavigator = () => {
  ...
  return (
    ...
    >
      <ProjectStack.Screen name="ProjectManagement" component={ProjectManagementScreen} />
      ...
      <ProjectStack.Screen name="EditProject" component={EditProjectScreen} />
      <ProjectStack.Screen name="FinalizeQuotation" component={FinalizeQuotationScreen} />
    </ProjectStack.Navigator>
  );
};
  ...
  return (
    ...
    >
      ...
      <Tab.Screen 
        ...
        options={{ title: 'Dự Án', headerShown: false }}
      />
      <Tab.Screen 
        name="Account" 
